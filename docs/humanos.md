...
> **A regra que organiza tudo:** cada grupo sobrevive por uma estratégia
> diferente, e a estratégia produz o tipo de gente.

| Grupo | Estratégia | O que virou |
|---|---|---|
| **O Conselho** | Muro, procedimento e monopólio | Burocracia com fome |
| **Os Cicatrizes** | Silêncio absoluto | Outra coisa |
| **A Clareira** | Esconderijo | *Não existe mais* |
| **Os militares** | Ordem e protocolo | Ainda um boato |
...
negocia com eles em desvantagem.
...
> Quem cortou o NPC da lista foi a **Neide**. E ela tinha razão.
>
> O azol que restava rendia mais em alguém com chance. O NPC já estava no
> estágio 2, e azol não segura o estágio 2. Gastar nele era desperdiçar em
> quem ia morrer de qualquer jeito.
>
> **Estava tecnicamente certo.** É por isso que dói.

E a perseguição depois da fuga não é por raiva: é porque a fuga virou
**precedente**, e precedente é problema administrativo. Wilson vai mandar
Bandeira. Bandeira vai.
...
| Nível | O que gerou | Resposta do Conselho |
|---|---|---|
| 0 | Sumiram | Nada. Duas bocas a menos |
| 1 | Levaram coisa do Depósito | Bandeira manda gente perguntar por eles |
| 2 | Atrapalharam uma rota, uma carga, um acordo | Batedores. Recompensa oferecida a terceiros |
| 3 | Custaram dinheiro, álcool ou gente | Grupo armado dedicado, com ordem de trazer de volta |
...
levaram isso até o fim:

- **Arco e flecha.** Silencioso, munição infinita, e se faz em casa.
- Sem arma de fogo, sem motor, sem metal batendo em metal, sem fogo à noite.
- **Pararam de falar** perto de estranhos. Não é mística: é disciplina de som
  que virou hábito e depois virou cultura.
- Matam quem entra porque **quem sai conta a alguém onde eles estão.**
...
> andando por aí. É raro, deliberado, e significa alguma coisa.

### E isso responde o fio solto
*"Existe uma forma de não ser morto por eles. Ninguém sabe qual é."*

Um Cicatriz que vira o rosto para alguém **está dizendo alguma coisa**. Está
oferecendo o nome, ou uma condição, ou um aviso.

**E ninguém de fora sabe ler.** O grupo pode receber a resposta várias vezes e
...
O grupo vai perceber que atravessou quilômetros sem ver um único infectado. E vai
levar tempo demais para entender por quê.

## Detalhes de mesa
- **Não se detecta um Caçador.** Detecta-se que alguma coisa está errada:
  silêncio de pássaro, uma marca em árvore, um infectado morto com um furo só.
- Eles observam por muito tempo antes de agir. Um grupo pode ser seguido por
  dois dias sem saber.
- **Sabem coisas que ninguém sabe.** Moram dentro do território perigoso há
  cinco anos. Conhecem os Gigantes pelo nome, sabem onde ficam os ninhos, sabem
  o que se move na chuva.
- Existe uma forma de não ser morto por eles. **Ninguém sabe qual é.**
...
- A cinza do fogão **ainda está morna**
- A comida na panela **ainda não secou**
- Moscas, e nada além de moscas
- Se o grupo tivesse chegado ontem, teria encontrado vinte pessoas

**Eles passaram perto. E isso é insuportável.**
...
## As perguntas que o grupo tem que responder
1. Saíram por vontade própria ou foram levados?
2. O portão está aberto **para dentro ou para fora**?
3. Por que ninguém pegou nada?
4. Para quem era a cova?

## Explicações candidatas
| | O que aconteceu | O que isso faz pela campanha |
|---|---|---|
| **A** *(recomendada)* | **Foram para o lugar melhor.** Souberam do boato antes, e foram | Confirma que o boato é real. E lá na frente o grupo descobre **quantos deles foram aceitos** |
| **B** | **Os Cicatrizes** os levaram ou expulsaram | Fecha o paralelo entre os dois grupos que se esconderam |
| **C** | **Os militares** passaram, fizeram triagem, levaram os saudáveis | Antecipa o preço da entrada. Brutal |
| **D** | Alguém virou lá dentro, à noite | Explica o alarme intacto: **o perigo já estava dentro** |

> **A recomendada é a A**, porque transforma a Clareira em **prévia** da
> campanha: eles fizeram exatamente o que o grupo está prestes a fazer. E o
> grupo vai descobrir como terminou.
...
- **Foram eles que bombardearam a região.** O posto de contenção na Zona
  Química é deles. As viaturas queimadas são deles. A vala de queima foi ordem
  deles.
- Sabem o que existe em Paulínia, porque **receberam a ordem de conter aquilo**.
- Têm Freio porque **estão produzindo**. E produzir exige testar.

> **O lugar melhor é dirigido pelas pessoas que envenenaram a terra que o grupo
