...
>
> É sempre o mesmo fungo. A mordida não escolhe o tipo.
>
> **O que você vira depende de três coisas: o corpo que ele pegou, até onde ele
> chegou, e onde você amadureceu.**

E a lei que rege tudo:

> ## O fungo não inventa órgãos. Ele reaproveita o que acha.

Todo tipo é o fungo achando um sistema do corpo que já fazia alguma coisa útil,
e tomando conta dele. É por isso que os tipos fazem sentido em vez de serem
poderes aleatórios.
...
O fungo é um organismo de clima frio que **por muito pouco** atravessou a
barreira dos 37 °C (T2). Ele tolera nosso calor. Não gosta dele.

| | |
|---|---|
| **No frio** | Cresce mais, cresce melhor, forma estruturas elaboradas. É onde nascem os tipos especializados. |
| **No calor** | Cresce mal, torto, incompleto. Infectados de região quente são mais frágeis e mais simples. |
...
3. **Estação úmida e fria é dois desastres ao mesmo tempo.** As pessoas viram
   mais rápido (a febre defende menos) **e** o fungo constrói monstros melhores.
   Uma estação dessas é um arco inteiro de campanha.

> ### Tendência, não regra
>
> **O frio favorece. Não determina.**
>
> Existem exceções, e elas não são raras o bastante para serem ignoradas: um
> hospedeiro excepcionalmente compatível, uma bolsa de umidade, um corpo que
> ficou tempo demais sem ser perturbado, ou simplesmente a variação do próprio
...
>
> E dá ao narrador liberdade para colocar qualquer coisa em qualquer lugar sem
> quebrar o próprio mundo.
...
>
> A barreira dos 37 °C é o que sempre nos protegeu (T2). O corpo está tentando
> **erguer a barreira de volta**, subindo a própria temperatura acima do que o
> fungo tolera.
>
...
**A mente está 100% intacta.** A pessoa vê o próprio corpo agir e sabe que não
foi ela. É este o estágio em que os primeiros infectados do mundo foram mandados
à psiquiatria (ver [origem.md](origem.md) §2).
...
>
> Logo: **infectado recente ainda é gente lá dentro. Infectado antigo não é.** E
> não dá para saber de olho qual é qual.
...
| +1 a 3 semanas | tipo definido |

**Inalação:** multiplique por 3 a 5. **Cepa selvagem:** por 4. **Frio:** encurte.
...
A rede já está **dentro do tecido**. O antifúngico impede crescimento novo, mas
não desfaz o que já cresceu.

> **Ele congela a pessoa no estágio em que ela está.** Parou de tomar, o relógio
> volta a andar exatamente de onde parou.

Isso significa que existem pessoas vivas em **todos os estágios**:
...
- É a moeda mais forte que existe, e é finita por definição.
...
**O bestiário completo, com a origem de cada tipo, está em
[`bestiario.md`](bestiario.md).**
